...
// SOLUCIÓN --> Algunos imorts son nuevos (promote)
...
export default function RestaurantsScreen ({ navigation, route }) {
  ...
  // SOLUCIÓN -->  Promocionar un restaurante
  ...
  return (
    ...
    {/* SOLUCIÓN  -->  Ventana de confirmación */}
    <ConfirmationModal
